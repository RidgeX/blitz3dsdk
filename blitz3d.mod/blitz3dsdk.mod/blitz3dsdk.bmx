...
Function bbErrorHandler(err:Byte Ptr) "win32"
	Local error$
	If err error=String.fromcstring(err)
	RuntimeError error
End Function

bbSetBlitz3DDebugCallback( bbErrorHandler )
...
EndRem
Function bbBeginBlitz3D()="bbBeginBlitz3D"
...
See Also: <a href=#bbendblitz3d>bbEndBlitz3D</a>
EndRem
Function bbBeginBlitz3DEx( hwnd,flags )="bbBeginBlitz3DEx"
...
EndRem
Function bbEndBlitz3D()="bbEndBlitz3D"

Rem
bbdoc: <p> Validates Blitz3d graphics state:
returns: -1 if graphics are permanently lost, 0 if temporarily lost or >0 if available.
EndRem
Function bbValidateGraphics()="bbValidateGraphics"
...
EndRem
Function bbSetBlitz3DDebugMode(debugmode)="bbSetBlitz3DDebugMode"
...
EndRem
Function bbSetBlitz3DDebugCallback(callback:Byte Ptr)="bbSetBlitz3DDebugCallback"
...
EndRem
Function bbSetBlitz3DEventCallback(callback)="bbSetBlitz3DEventCallback"
...
EndRem
Function bbSetBlitz3DHWND(hwndparent)="bbSetBlitz3DHWND"
...
EndRem
Function bbSetBlitz3DTitle(windowtitle$z,quitmessage$z)="bbSetBlitz3DTitle"
...
EndRem
Function bbGraphics(width,height,depth=0,mode=0)="bbGraphics"
...
EndRem
Function bbFlip(synch=True)="bbFlip"
...
EndRem
Function bbBackBuffer()="bbBackBuffer"
...
EndRem
Function bbFrontBuffer()="bbFrontBuffer"
...
EndRem
Function bbGraphicsWidth()="bbGraphicsWidth"
...
EndRem
Function bbGraphicsHeight()="bbGraphicsHeight"
...
EndRem
Function bbGraphicsDepth()="bbGraphicsDepth"
...
EndRem
Function bbEndGraphics()="bbEndGraphics"
...
EndRem
Function bbVWait(frames=1)="bbVWait"
...
EndRem
Function bbScanLine()="bbScanLine"
...
EndRem
Function bbTotalVidMem()="bbTotalVidMem"
...
EndRem
Function bbAvailVidMem()="bbAvailVidMem"
...
EndRem
Function bbSetGamma(red,green,blue,dest_red#,dest_green#,dest_blue#)="bbSetGamma"
...
EndRem
Function bbUpdateGamma(calibrate=0)="bbUpdateGamma"
...
EndRem
Function bbGammaRed(value)="bbGammaRed"
...
EndRem
Function bbGammaGreen(value)="bbGammaGreen"
...
EndRem
Function bbGammaBlue(value)="bbGammaBlue"
...
EndRem
Function bbWrite(value$z)="bbWrite"
...
See Also: <a href=#bbprint>bbPrint</a> <a href=#bblocate>bbLocate</a>
EndRem
Function bbInput$z(prompt$z)="bbInput"
...
EndRem
Function bbLocate(x,y)="bbLocate"
...
EndRem
Function bbLine(x1,y1,x2,y2)="bbLine"
...
EndRem
Function bbRect(x,y,width,height,solid=True)="bbRect"
...
EndRem
Function bbOval(x,y,width,height,solid=True)="bbOval"
...
EndRem
Function bbColor(red,green,blue)="bbColor"
...
EndRem
Function bbClsColor(red,green,blue)="bbClsColor"
...
EndRem
Function bbOrigin(x,y)="bbOrigin"
...
EndRem
Function bbViewport(x,y,width,height)="bbViewport"
...
EndRem
Function bbGetColor(x,y)="bbGetColor"
...
EndRem
Function bbColorRed()="bbColorRed"
...
EndRem
Function bbColorGreen()="bbColorGreen"
...
EndRem
Function bbColorBlue()="bbColorBlue"
...
EndRem
Function bbText(x,y,str$z,centerX=False,centerY=False)="bbText"
...
EndRem
Function bbLoadFont(FontName$z,height=12,bold=False,italic=False,underlined=False)="bbLoadFont"
...
EndRem
Function bbSetFont(fonthandle)="bbSetFont"
...
EndRem
Function bbFreeFont(fonthandle)="bbFreeFont"
...
EndRem
Function bbFontWidth()="bbFontWidth"
...
EndRem
Function bbFontHeight()="bbFontHeight"
...
EndRem
Function bbStringWidth(str$z)="bbStringWidth"
...
EndRem
Function bbStringHeight(str$z)="bbStringHeight"
...
EndRem
Function bbLoadImage(filename$z)="bbLoadImage"
...
EndRem
Function bbLoadAnimImage(filename$z,width,height,first,count)="bbLoadAnimImage"
...
EndRem
Function bbCreateImage(width,height,frames=1)="bbCreateImage"
...
EndRem
Function bbMaskImage(image,red,green,blue)="bbMaskImage"
...
EndRem
Function bbImageWidth(image)="bbImageWidth"
...
EndRem
Function bbImageHeight(image)="bbImageHeight"
...
EndRem
Function bbSaveImage(image,bmpfile$z,frame=0)="bbSaveImage"
...
EndRem
Function bbFreeImage(image)="bbFreeImage"
...
EndRem
Function bbDrawImage(image,x,y,frame=0)="bbDrawImage"
...
EndRem
Function bbDrawBlock(image,x,y,frame=0)="bbDrawBlock"
...
EndRem
Function bbDrawImageRect(image,x,y,image_x,image_y,width,height,frame=0)="bbDrawImageRect"
...
EndRem
Function bbDrawBlockRect(image,x,y,image_x,image_y,width,height,frame=0)="bbDrawBlockRect"
...
EndRem
Function bbTileImage(image,x,y,frame=0)="bbTileImage"
...
EndRem
Function bbTileBlock(image,x,y,frame=0)="bbTileBlock"
...
EndRem
Function bbHandleImage(image,x,y)="bbHandleImage"
...
EndRem
Function bbMidHandle(image)="bbMidHandle"
...
EndRem
Function bbAutoMidHandle(enable)="bbAutoMidHandle"
...
EndRem
Function bbImageXHandle(image)="bbImageXHandle"
...
EndRem
Function bbImageYHandle(image)="bbImageYHandle"
...
EndRem
Function bbCopyImage(image)="bbCopyImage"
...
EndRem
Function bbGrabImage(image,x,y,frame=0)="bbGrabImage"
...
EndRem
Function bbImageBuffer(image,frame=0)="bbImageBuffer"
...
EndRem
Function bbScaleImage(image,xscale#,yscale#)="bbScaleImage"
...
EndRem
Function bbResizeImage(image,width#,height#)="bbResizeImage"
...
EndRem
Function bbRotateImage(image,angle#)="bbRotateImage"
...
EndRem
Function bbTFormImage(image,m11#,m12#,m21#,m22#)="bbTFormImage"
...
EndRem
Function bbTFormFilter(enable)="bbTFormFilter"
...
EndRem
Function bbRectsOverlap(x1,y1,w1,h1,x2,y2,w2,h2)="bbRectsOverlap"
...
EndRem
Function bbImagesOverlap(image1,x1,y1,image2,x2,y2)="bbImagesOverlap"
...
EndRem
Function bbImagesCollide(image1,x1,y1,frame1,image2,x2,y2,frame2)="bbImagesCollide"
...
EndRem
Function bbImageRectOverlap(image,x,y,rectx,recty,rectw,recth)="bbImageRectOverlap"
...
EndRem
Function bbImageRectCollide(image,x,y,frame,rectx,recty,rectw,recth)="bbImageRectCollide"
...
EndRem
Function bbSetBuffer(buffer)="bbSetBuffer"
...
EndRem
Function bbGraphicsBuffer()="bbGraphicsBuffer"
...
EndRem
Function bbLoadBuffer(buffer,filename$z)="bbLoadBuffer"
...
EndRem
Function bbSaveBuffer(buffer,filename$z)="bbSaveBuffer"

Rem
bbdoc: Mark a buffer as dirty
End Rem
Function bbBufferDirty(buffer)="bbBufferDirty"
...
EndRem
Function bbReadPixel(x,y,buffer=0)="bbReadPixel"
...
EndRem
Function bbWritePixel(x,y,color,buffer=0)="bbWritePixel"
...
EndRem
Function bbCopyPixel(src_x,src_y,src_buffer,dest_x,dest_y,dest_buffer=0)="bbCopyPixel"
...
EndRem
Function bbCopyRect(src_x,src_y,width,height,dest_x,dest_y,src_buffer=0,dest_buffer=0)="bbCopyRect"
...
EndRem
Function bbLockBuffer(buffer=0)="bbLockBuffer"
...
EndRem
Function bbUnlockBuffer(buffer=0)="bbUnlockBuffer"
...
EndRem
Function bbReadPixelFast(x,y,buffer=0)="bbReadPixelFast"
...
EndRem
Function bbWritePixelFast(x,y,color,buffer=0)="bbWritePixelFast"
...
EndRem
Function bbCopyPixelFast(src_x,src_y,src_buffer,dest_x,dest_y,dest_buffer=0)="bbCopyPixelFast"
...
EndRem
Function bbCountGfxModes()="bbCountGfxModes"
...
EndRem
Function bbGfxModeWidth(mode)="bbGfxModeWidth"
...
See Also: <a href=#bbcountgfxmodes>bbCountGfxModes</a> <a href=#bbgfxmodeheight>bbGfxModeHeight</a> <a href=#bbgfxmodedepth>bbGfxModeDepth</a>
EndRem
Function bbGfxModeHeight(mode)="bbGfxModeHeight"
...
See Also: <a href=#bbcountgfxmodes>bbCountGfxModes</a> <a href=#bbgfxmodeheight>bbGfxModeHeight</a> <a href=#bbgfxmodedepth>bbGfxModeDepth</a>
EndRem
Function bbGfxModeDepth(mode)="bbGfxModeDepth"
...
EndRem
Function bbGfxModeExists(width,height,depth)="bbGfxModeExists"
...
EndRem
Function bbCountGfxDrivers()="bbCountGfxDrivers"
...
EndRem
Function bbGfxDriverName$z(index)="bbGfxDriverName"
...
EndRem
Function bbSetGfxDriver(index)="bbSetGfxDriver"
...
EndRem
Function bbLoadSound(filename$z)="bbLoadSound"
...
EndRem
Function bbPlaySound(sound)="bbPlaySound"
...
EndRem
Function bbFreeSound(sound)="bbFreeSound"
...
EndRem
Function bbLoopSound(sound)="bbLoopSound"
...
EndRem
Function bbSoundPitch(sound,samplerate)="bbSoundPitch"
...
EndRem
Function bbSoundVolume(sound,volume#)="bbSoundVolume"
...
EndRem
Function bbSoundPan(sound,pan#)="bbSoundPan"
...
EndRem
Function bbPlayMusic(filename$z)="bbPlayMusic"
...
EndRem
Function bbPlayCDTrack(track,mode=1)="bbPlayCDTrack"
...
EndRem
Function bbStopChannel(channel)="bbStopChannel"
...
EndRem
Function bbPauseChannel(channel)="bbPauseChannel"
...
EndRem
Function bbResumeChannel(channel)="bbResumeChannel"
...
EndRem
Function bbChannelPitch(channel,samplerate)="bbChannelPitch"
...
EndRem
Function bbChannelVolume(channel,volume#)="bbChannelVolume"
...
EndRem
Function bbChannelPan(channel,pan#)="bbChannelPan"
...
EndRem
Function bbChannelPlaying(channel)="bbChannelPlaying"
...
EndRem
Function bbOpenMovie(moviefile$z)="bbOpenMovie"
...
EndRem
Function bbCloseMovie(movie)="bbCloseMovie"
...
EndRem
Function bbDrawMovie(movie,x,y,width,height=0)="bbDrawMovie"
...
EndRem
Function bbMovieWidth(movie)="bbMovieWidth"
...
EndRem
Function bbMovieHeight(movie)="bbMovieHeight"
...
EndRem
Function bbMoviePlaying(movie)="bbMoviePlaying"
...
EndRem
Function bbKeyDown(scancode)="bbKeyDown"
...
EndRem
Function bbKeyHit(scancode)="bbKeyHit"
...
EndRem
Function bbFlushKeys()="bbFlushKeys"
...
EndRem
Function bbMouseDown(button)="bbMouseDown"
...
EndRem
Function bbMouseHit(button)="bbMouseHit"
...
EndRem
Function bbGetMouse()="bbGetMouse"
...
EndRem
Function bbWaitMouse()="bbWaitMouse"
...
EndRem
Function bbShowPointer()="bbShowPointer"
...
EndRem
Function bbHidePointer()="bbHidePointer"
...
EndRem
Function bbMoveMouse(x,y)="bbMoveMouse"
...
EndRem
Function bbMouseXSpeed()="bbMouseXSpeed"
...
EndRem
Function bbMouseYSpeed()="bbMouseYSpeed"
...
EndRem
Function bbMouseZSpeed()="bbMouseZSpeed"
...
EndRem
Function bbFlushMouse()="bbFlushMouse"
...
EndRem
Function bbJoyType(port=0)="bbJoyType"
...
EndRem
Function bbGetJoy(port=0)="bbGetJoy"
...
EndRem
Function bbJoyDown(button,port=0)="bbJoyDown"
...
EndRem
Function bbJoyHit(button,port=0)="bbJoyHit"
...
See Also: <a href=#bbjoytype>bbJoyType</a>
EndRem
Function bbWaitJoy(port=0)="bbWaitJoy"
...
EndRem
Function bbFlushJoy()="bbFlushJoy"
...
EndRem
Function bbJoyXDir(port=0)="bbJoyXDir"
...
EndRem
Function bbJoyYDir(port=0)="bbJoyYDir"
...
EndRem
Function bbJoyZDir(port=0)="bbJoyZDir"
...
EndRem
Function bbJoyUDir(port=0)="bbJoyUDir"
...
See Also: <a href=#bbjoyy>bbJoyY</a> <a href=#bbjoyxdir>bbJoyXDir</a>
EndRem
Function bbJoyVDir(port=0)="bbJoyVDir"
...
See Also: <a href=#bbjoyx>bbJoyX</a> <a href=#bbjoyy>bbJoyY</a> <a href=#bbjoyz>bbJoyZ</a> <a href=#bbjoyu>bbJoyU</a> <a href=#bbjoyyaw>bbJoyYaw</a> <a href=#bbjoypitch>bbJoyPitch</a> <a href=#bbjoyroll>bbJoyRoll</a>
EndRem
Function bbJoyYaw#(port=0)="bbJoyYaw"
...
See Also: <a href=#bbjoyx>bbJoyX</a> <a href=#bbjoyy>bbJoyY</a> <a href=#bbjoyz>bbJoyZ</a> <a href=#bbjoyu>bbJoyU</a> <a href=#bbjoyyaw>bbJoyYaw</a> <a href=#bbjoypitch>bbJoyPitch</a> <a href=#bbjoyroll>bbJoyRoll</a>
EndRem
Function bbJoyPitch#(port=0)="bbJoyPitch"
...
See Also: <a href=#bbjoyx>bbJoyX</a> <a href=#bbjoyy>bbJoyY</a> <a href=#bbjoyz>bbJoyZ</a> <a href=#bbjoyu>bbJoyU</a> <a href=#bbjoyyaw>bbJoyYaw</a> <a href=#bbjoypitch>bbJoyPitch</a> <a href=#bbjoyroll>bbJoyRoll</a>
EndRem
Function bbJoyRoll#(port=0)="bbJoyRoll"
...
EndRem
Function bbGraphics3D(width,height,depth=0,mode=0)="bbGraphics3D"
...
EndRem
Function bbDither(enable)="bbDither"
...
EndRem
Function bbWBuffer(enable)="bbWBuffer"
...
EndRem
Function bbAntiAlias(enable)="bbAntiAlias"
...
EndRem
Function bbWireFrame(enable)="bbWireFrame"
...
EndRem
Function bbHWMultiTex(enable)="bbHWMultiTex"
...
EndRem
Function bbRenderWorld(tween#=1.0)="bbRenderWorld"
...
EndRem
Function bbUpdateWorld(anim_speed#=1.0)="bbUpdateWorld"
...
EndRem
Function bbCaptureWorld()="bbCaptureWorld"
...
EndRem
Function bbClearWorld(entities=True,brushes=True,textures=True)="bbClearWorld"
...
EndRem
Function bbTrisRendered()="bbTrisRendered"
...
EndRem
Function bbCreateCamera(parent=0)="bbCreateCamera"
...
EndRem
Function bbCameraViewport(camera,x,y,width,height)="bbCameraViewport"
...
EndRem
Function bbCameraClsMode(camera,cls_color,cls_zbuffer)="bbCameraClsMode"
...
EndRem
Function bbCameraClsColor(camera,red#,green#,blue#)="bbCameraClsColor"
...
EndRem
Function bbCameraRange(camera,near#,far#)="bbCameraRange"
...
EndRem
Function bbCameraZoom(camera,zoom#)="bbCameraZoom"
...
EndRem
Function bbCameraProjMode(camera,mode)="bbCameraProjMode"
...
EndRem
Function bbCameraFogMode(camera,mode)="bbCameraFogMode"
...
EndRem
Function bbCameraFogColor(camera,red#,green#,blue#)="bbCameraFogColor"
...
EndRem
Function bbCameraFogRange(camera,near#,far#)="bbCameraFogRange"
...
EndRem
Function bbCameraProject(camera,x#,y#,z#)="bbCameraProject"
...
EndRem
Function bbProjectedX#()="bbProjectedX"
...
See Also: <a href=#bbcameraproject>bbCameraProject</a>
EndRem
Function bbProjectedY#()="bbProjectedY"
...
See Also: <a href=#bbcameraproject>bbCameraProject</a>
EndRem
Function bbProjectedZ#()="bbProjectedZ"
...
EndRem
Function bbEntityInView(entity,camera)="bbEntityInView"
...
EndRem
Function bbAmbientLight(red#,green#,blue#)="bbAmbientLight"
...
EndRem
Function bbCreateLight(light_type=0,parent=0)="bbCreateLight"
...
EndRem
Function bbLightRange(light,range#)="bbLightRange"
...
EndRem
Function bbLightColor(light,red#,green#,blue#)="bbLightColor"
...
EndRem
Function bbLightConeAngles(light,inner_angle#,outer_angle#)="bbLightConeAngles"
...
EndRem
Function bbCreatePivot(parent=0)="bbCreatePivot"
...
EndRem
Function bbCreateCube(parent=0)="bbCreateCube"
...
EndRem
Function bbCreateSphere(segments=8,parent=0)="bbCreateSphere"
...
EndRem
Function bbCreateCylinder(segments=8,solid=True,parent=0)="bbCreateCylinder"
...
EndRem
Function bbCreateCone(segments=8,solid=True,parent=0)="bbCreateCone"
...
EndRem
Function bbCreatePlane(divisions=1,parent=0)="bbCreatePlane"
...
EndRem
Function bbCreateMirror(parent=0)="bbCreateMirror"
...
EndRem
Function bbCopyEntity(entity,parent=0)="bbCopyEntity"
...
EndRem
Function bbLoadTexture(file$z,flags=1)="bbLoadTexture"
...
EndRem
Function bbLoadAnimTexture(file$z,flags,frame_width,frame_height,first_frame,frame_count)="bbLoadAnimTexture"
...
EndRem
Function bbCreateTexture(width,height,flags=0,frames=1)="bbCreateTexture"
...
EndRem
Function bbFreeTexture(texture)="bbFreeTexture"
...
EndRem
Function bbTextureBlend(texture,blend)="bbTextureBlend"
...
EndRem
Function bbTextureCoords(texture,coords)="bbTextureCoords"
...
EndRem
Function bbScaleTexture(texture,u_scale#,v_scale#)="bbScaleTexture"
...
EndRem
Function bbPositionTexture(texture,u_position#,v_position#)="bbPositionTexture"
...
EndRem
Function bbRotateTexture(texture,angle#)="bbRotateTexture"
...
EndRem
Function bbTextureWidth(texture)="bbTextureWidth"
...
EndRem
Function bbTextureHeight(texture)="bbTextureHeight"
...
EndRem
Function bbTextureBuffer(texture,frame=0)="bbTextureBuffer"
...
EndRem
Function bbGetBrushTexture(brush,index=0)="bbGetBrushTexture"
...
EndRem
Function bbTextureFilter(match_text$z,flags)="bbTextureFilter"
...
EndRem
Function bbClearTextureFilters()="bbClearTextureFilters"
...
EndRem
Function bbSetCubeFace(texture,face)="bbSetCubeFace"
...
EndRem
Function bbSetCubeMode(texture,mode)="bbSetCubeMode"
...
EndRem
Function bbCreateBrush(red#=255,green#=255,blue#=255)="bbCreateBrush"
...
EndRem
Function bbLoadBrush(texture_file$z,flags=1,u_scale#=1,v_scale#=1)="bbLoadBrush"
...
EndRem
Function bbFreeBrush(brush)="bbFreeBrush"
...
EndRem
Function bbBrushColor(brush,red#,green#,blue#)="bbBrushColor"
...
EndRem
Function bbBrushAlpha(brush,alpha#)="bbBrushAlpha"
...
EndRem
Function bbBrushBlend(brush,blend)="bbBrushBlend"
...
EndRem
Function bbBrushFX(brush,fx)="bbBrushFX"
...
EndRem
Function bbBrushShininess(brush,shininess#)="bbBrushShininess"
...
EndRem
Function bbBrushTexture(brush,texture,frame=0,index=0)="bbBrushTexture"
...
EndRem
Function bbGetEntityBrush(entity)="bbGetEntityBrush"
...
EndRem
Function bbGetSurfaceBrush(surface)="bbGetSurfaceBrush"
...
EndRem
Function bbCountGfxModes3D()="bbCountGfxModes3D"
...
EndRem
Function bbGfxMode3D(mode)="bbGfxMode3D"
...
EndRem
Function bbWindowed3D()="bbWindowed3D"
...
EndRem
Function bbGfxMode3DExists(width,height,depth)="bbGfxMode3DExists"
...
EndRem
Function bbGfxDriver3D(driver)="bbGfxDriver3D"
...
EndRem
Function bbGfxDriverCaps3D()="bbGfxDriverCaps3D"
...
EndRem
Function bbHWTexUnits()="bbHWTexUnits"
...
EndRem
Function bbVectorYaw#(x#,y#,z#)="bbVectorYaw"
...
EndRem
Function bbVectorPitch#(x#,y#,z#)="bbVectorPitch"
...
EndRem
Function bbTFormPoint(x#,y#,z#,source_entity,dest_entity)="bbTFormPoint"
...
EndRem
Function bbTFormVector(x#,y#,z#,source_entity,dest_entity)="bbTFormVector"
...
EndRem
Function bbTFormNormal(x#,y#,z#,source_entity,dest_entity)="bbTFormNormal"
...
EndRem
Function bbTFormedX#()="bbTFormedX"
...
EndRem
Function bbTFormedY#()="bbTFormedY"
...
EndRem
Function bbTFormedZ#()="bbTFormedZ"
...
EndRem
Function bbPositionEntity(entity,x#,y#,z#,globalspace=0)="bbPositionEntity"
...
EndRem
Function bbMoveEntity(entity,x#,y#,z#)="bbMoveEntity"
...
EndRem
Function bbTranslateEntity(entity,x#,y#,z#,globalspace=0)="bbTranslateEntity"
...
EndRem
Function bbEntityX#(entity,globalspace=0)="bbEntityX"
...
EndRem
Function bbEntityY#(entity,globalspace=0)="bbEntityY"
...
EndRem
Function bbEntityZ#(entity,globalspace=0)="bbEntityZ"
...
EndRem
Function bbRotateEntity(entity,pitch#,yaw#,roll#,globalspace=0)="bbRotateEntity"
...
EndRem
Function bbTurnEntity(entity,pitch#,yaw#,roll#,globalspace=0)="bbTurnEntity"
...
EndRem
Function bbPointEntity(entity,target,roll#=0)="bbPointEntity"
...
EndRem
Function bbAlignToVector(entity,vector_x#,vector_y#,vector_z#,axis,rate#=1.0)="bbAlignToVector"
...
EndRem
Function bbEntityRoll#(entity,globalspace=0)="bbEntityRoll"
...
EndRem
Function bbEntityYaw#(entity,globalspace=0)="bbEntityYaw"
...
EndRem
Function bbEntityPitch#(entity,globalspace=0)="bbEntityPitch"
...
EndRem
Function bbGetMatElement#(entity,row,column)="bbGetMatElement"
...
EndRem
Function bbScaleEntity(entity,x_scale#,y_scale#,z_scale#,globalspace=0)="bbScaleEntity"
...
EndRem
Function bbEntityParent(entity,parent,globalspace=True)="bbEntityParent"
...
EndRem
Function bbGetParent(entity)="bbGetParent"
...
EndRem
Function bbCountChildren(entity)="bbCountChildren"
...
EndRem
Function bbGetChild(entity,index)="bbGetChild"
...
EndRem
Function bbFindChild(entity,child_name$z)="bbFindChild"
...
EndRem
Function bbShowEntity(entity)="bbShowEntity"
...
EndRem
Function bbHideEntity(entity)="bbHideEntity"
...
See Also: <a href=#bbentityalpha>bbEntityAlpha</a>
EndRem
Function bbEntityAutoFade(entity,near#,far#)="bbEntityAutoFade"
...
EndRem
Function bbEntityOrder(entity,order)="bbEntityOrder"
...
EndRem
Function bbFreeEntity(EntityHandle)="bbFreeEntity"
...
EndRem
Function bbEntityColor(entity,red#,green#,blue#)="bbEntityColor"
...
EndRem
Function bbEntityAlpha(entity,alpha#)="bbEntityAlpha"
...
EndRem
Function bbEntityShininess(entity,shininess#)="bbEntityShininess"
...
EndRem
Function bbEntityTexture(entity,texture,frame=0,index=0)="bbEntityTexture"
...
EndRem
Function bbEntityBlend(entity,blend)="bbEntityBlend"
...
EndRem
Function bbEntityFX(entity,fx)="bbEntityFX"
...
EndRem
Function bbPaintEntity(entity,brush)="bbPaintEntity"
...
EndRem
Function bbCollisions(src_type,dest_type,detectionmethod,response)="bbCollisions"
...
EndRem
Function bbClearCollisions()="bbClearCollisions"
...
EndRem
Function bbEntityType(entity,collision_type,recursive=0)="bbEntityType"
...
EndRem
Function bbGetEntityType(entity)="bbGetEntityType"
...
EndRem
Function bbResetEntity(entity)="bbResetEntity"
...
EndRem
Function bbEntityRadius(entity,x_radius#,y_radius#=0)="bbEntityRadius"
...
EndRem
Function bbEntityBox(entity,x#,y#,z#,width#,height#,depth#)="bbEntityBox"
...
EndRem
Function bbEntityCollided(entity,src_type)="bbEntityCollided"
...
EndRem
Function bbCountCollisions(entity)="bbCountCollisions"
...
EndRem
Function bbCollisionX#(entity,index)="bbCollisionX"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionY#(entity,index)="bbCollisionY"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionZ#(entity,index)="bbCollisionZ"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionNX#(entity,index)="bbCollisionNX"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionNY#(entity,index)="bbCollisionNY"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionNZ#(entity,index)="bbCollisionNZ"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionTime#(entity,index)="bbCollisionTime"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionEntity(entity,index)="bbCollisionEntity"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionSurface(entity,index)="bbCollisionSurface"
...
See Also: <a href=#bbcollisionx>bbCollisionX</a> <a href=#bbcollisiony>bbCollisionY</a> <a href=#bbcollisionz>bbCollisionZ</a> <a href=#bbcollisionnx>bbCollisionNX</a> <a href=#bbcollisionny>bbCollisionNY</a> <a href=#bbcollisionnz>bbCollisionNZ</a> <a href=#bbcountcollisions>bbCountCollisions</a> <a href=#bbentitycollided>bbEntityCollided</a> <a href=#bbcollisiontime>bbCollisionTime</a> <a href=#bbcollisionentity>bbCollisionEntity</a> <a href=#bbcollisionsurface>bbCollisionSurface</a> <a href=#bbcollisiontriangle>bbCollisionTriangle</a>
EndRem
Function bbCollisionTriangle(entity,index)="bbCollisionTriangle"
...
EndRem
Function bbEntityPickMode(entity,pick_geometry,obscurer=True)="bbEntityPickMode"
...
See Also: <a href=#bbentitypick>bbEntityPick</a> <a href=#bblinepick>bbLinePick</a> <a href=#bbcamerapick>bbCameraPick</a> <a href=#bbentitypickmode>bbEntityPickMode</a>
EndRem
Function bbLinePick(x#,y#,z#,dx#,dy#,dz#,radius#=0)="bbLinePick"
...
EndRem
Function bbEntityPick(entity,range#)="bbEntityPick"
...
EndRem
Function bbCameraPick(camera,viewport_x#,viewport_y#)="bbCameraPick"
...
EndRem
Function bbPickedNX#()="bbPickedNX"
...
EndRem
Function bbPickedNY#()="bbPickedNY"
...
EndRem
Function bbPickedNZ#()="bbPickedNZ"
...
EndRem
Function bbPickedEntity()="bbPickedEntity"
...
EndRem
Function bbPickedSurface()="bbPickedSurface"
...
EndRem
Function bbPickedTriangle()="bbPickedTriangle"
...
EndRem
Function bbLoadMesh(filename$z,parent=0)="bbLoadMesh"
...
EndRem
Function bbLoadAnimMesh(filename$z,parent=0)="bbLoadAnimMesh"
...
EndRem
Function bbLoaderMatrix(file_extension$z,xx#,xy#,xz#,yx#,yy#,yz#,zx#,zy#,zz#)="bbLoaderMatrix"
...
EndRem
Function bbCopyMesh(mesh,parent=0)="bbCopyMesh"
...
EndRem
Function bbCreateMesh(parent=0)="bbCreateMesh"
...
EndRem
Function bbAddMesh(source_mesh,dest_mesh)="bbAddMesh"
...
EndRem
Function bbFlipMesh(mesh)="bbFlipMesh"
...
EndRem
Function bbPaintMesh(mesh,brush)="bbPaintMesh"
...
EndRem
Function bbLightMesh(mesh,red#,green#,blue#,range#=0,light_x#=0,light_y#=0,light_z#=0)="bbLightMesh"
...
EndRem
Function bbFitMesh(mesh,x#,y#,z#,width#,height#,depth#,uniform=0)="bbFitMesh"
...
EndRem
Function bbScaleMesh(mesh,x_scale#,y_scale#,z_scale#)="bbScaleMesh"
...
EndRem
Function bbRotateMesh(mesh,pitch#,yaw#,roll#)="bbRotateMesh"
...
EndRem
Function bbPositionMesh(mesh,x#,y#,z#)="bbPositionMesh"
...
EndRem
Function bbUpdateNormals(mesh)="bbUpdateNormals"
...
EndRem
Function bbMeshesIntersect(mesh_a,mesh_b)="bbMeshesIntersect"
...
EndRem
Function bbMeshWidth#(mesh)="bbMeshWidth"
...
EndRem
Function bbMeshHeight#(mesh)="bbMeshHeight"
...
EndRem
Function bbMeshDepth#(mesh)="bbMeshDepth"
...
EndRem
Function bbMeshCullBox(mesh,x#,y#,z#,w#,h#,d#)="bbMeshCullBox"
...
EndRem
Function bbCountSurfaces(mesh)="bbCountSurfaces"
...
EndRem
Function bbGetSurface(mesh,index)="bbGetSurface"
...
EndRem
Function bbCreateSurface(mesh,brush=0)="bbCreateSurface"
...
EndRem
Function bbPaintSurface(surface,brush)="bbPaintSurface"
...
EndRem
Function bbClearSurface(surface,clear_verts,clear_triangles=0)="bbClearSurface"
...
EndRem
Function bbFindSurface(mesh,brush)="bbFindSurface"
...
EndRem
Function bbAddVertex(surface,x#,y#,z#,u#=0,v#=0,w#=1)="bbAddVertex"
...
EndRem
Function bbAddTriangle(surface,v0,v1,v2)="bbAddTriangle"
...
EndRem
Function bbVertexCoords(surface,index,x#,y#,z#)="bbVertexCoords"
...
EndRem
Function bbVertexNormal(surface,index,nx#,ny#,nz#)="bbVertexNormal"
...
EndRem
Function bbVertexColor(surface,index,red#,green#,blue#,alpha#=1)="bbVertexColor"
...
EndRem
Function bbVertexTexCoords(surface,index,u#,v#,w#=1,coord_set=0)="bbVertexTexCoords"
...
EndRem
Function bbCountVertices(surface)="bbCountVertices"
...
EndRem
Function bbCountTriangles(surface)="bbCountTriangles"
...
EndRem
Function bbVertexX#(surface,index)="bbVertexX"
...
EndRem
Function bbVertexY#(surface,index)="bbVertexY"
...
EndRem
Function bbVertexZ#(surface,index)="bbVertexZ"
...
EndRem
Function bbVertexNX#(surface,index)="bbVertexNX"
...
EndRem
Function bbVertexNY#(surface,index)="bbVertexNY"
...
EndRem
Function bbVertexNZ#(surface,index)="bbVertexNZ"
...
EndRem
Function bbVertexRed#(surface,index)="bbVertexRed"
...
EndRem
Function bbVertexGreen#(surface,index)="bbVertexGreen"
...
EndRem
Function bbVertexBlue#(surface,index)="bbVertexBlue"
...
EndRem
Function bbVertexAlpha#(surface,index)="bbVertexAlpha"
...
EndRem
Function bbVertexU#(surface,index,coord_set=0)="bbVertexU"
...
EndRem
Function bbVertexV#(surface,index,coord_set=0)="bbVertexV"
...
EndRem
Function bbVertexW#(surface,index)="bbVertexW"
...
EndRem
Function bbTriangleVertex(surface,triangle_index,corner)="bbTriangleVertex"
...
EndRem
Function bbNameEntity(entity,name$z)="bbNameEntity"
...
EndRem
Function bbEntityID(entity)="bbEntityID"
...
EndRem
Function bbSetEntityID(entity,id)="bbSetEntityID"
...
EndRem
Function bbCaptureEntity(entity)="bbCaptureEntity"
...
EndRem
Function bbEntityVisible(src_entity,dest_entity)="bbEntityVisible"
...
EndRem
Function bbEntityDistance#(src_entity,dest_entity)="bbEntityDistance"
...
EndRem
Function bbDeltaYaw#(src_entity,dest_entity)="bbDeltaYaw"
...
EndRem
Function bbDeltaPitch#(src_entity,dest_entity)="bbDeltaPitch"
...
EndRem
Function bbAnimate(entity,mode=1,speed#=1.0,sequence=0,transition#=0)="bbAnimate"
...
EndRem
Function bbExtractAnimSeq(entity,first_frame,last_frame,anim_seq=0)="bbExtractAnimSeq"
...
EndRem
Function bbAddAnimSeq(entity,length)="bbAddAnimSeq"
...
EndRem
Function bbSetAnimKey(entity,frame,pos_key=True,rot_key=True,scale_key=True)="bbSetAnimKey"
...
See Also: <a href=#bbloadanimmesh>bbLoadAnimMesh</a>
EndRem
Function bbLoadAnimSeq(entity,filename$z)="bbLoadAnimSeq"
...
EndRem
Function bbSetAnimTime(entity,time#,anim_seq=0)="bbSetAnimTime"
...
EndRem
Function bbAnimSeq(entity)="bbAnimSeq"
...
EndRem
Function bbAnimLength(entity)="bbAnimLength"
...
EndRem
Function bbAnimTime#(entity)="bbAnimTime"
...
EndRem
Function bbAnimating(entity)="bbAnimating"
...
EndRem
Function bbCreateTerrain(grid_size,parent=0)="bbCreateTerrain"
...
EndRem
Function bbLoadTerrain(file$z,parent=0)="bbLoadTerrain"
...
EndRem
Function bbTerrainDetail(terrain,detail_level,vertex_morph=0)="bbTerrainDetail"
...
EndRem
Function bbTerrainShading(terrain,enable)="bbTerrainShading"
...
EndRem
Function bbModifyTerrain(terrain,grid_x,grid_z,height#,realtime=0)="bbModifyTerrain"
...
EndRem
Function bbTerrainSize(terrain)="bbTerrainSize"
...
EndRem
Function bbTerrainHeight#(terrain,grid_x,grid_z)="bbTerrainHeight"
...
EndRem
Function bbTerrainX#(terrain,x#,y#,z#)="bbTerrainX"
...
EndRem
Function bbTerrainY#(terrain,x#,y#,z#)="bbTerrainY"
...
EndRem
Function bbTerrainZ#(terrain,x#,y#,z#)="bbTerrainZ"
...
EndRem
Function bbCreateSprite(parent=0)="bbCreateSprite"
...
See Also: <a href=#bbloadsprite>bbLoadSprite</a> <a href=#bbrotatesprite>bbRotateSprite</a> <a href=#bbscalesprite>bbScaleSprite</a> <a href=#bbhandlesprite>bbHandleSprite</a> <a href=#bbspriteviewmode>bbSpriteViewMode</a> <a href=#bbpositionentity>bbPositionEntity</a> <a href=#bbmoveentity>bbMoveEntity</a> <a href=#bbtranslateentity>bbTranslateEntity</a> <a href=#bbentityalpha>bbEntityAlpha</a> <a href=#bbfreeentity>bbFreeEntity</a>
EndRem
Function bbLoadSprite(path$z,texture_flags=1,parent=0)="bbLoadSprite"
...
EndRem
Function bbSpriteViewMode(sprite,view_mode)="bbSpriteViewMode"
...
See Also: <a href=#bbcreatesprite>bbCreateSprite</a> <a href=#bbloadsprite>bbLoadSprite</a>
EndRem
Function bbRotateSprite(sprite,angle#)="bbRotateSprite"
...
EndRem
Function bbScaleSprite(sprite,x_scale#,y_scale#)="bbScaleSprite"
...
See Also: <a href=#bbloadsprite>bbLoadSprite</a> <a href=#bbcreatesprite>bbCreateSprite</a>
EndRem
Function bbHandleSprite(sprite,x_handle#,y_handle#)="bbHandleSprite"
...
EndRem
Function bbLoadMD2(md2_file$z,parent=0)="bbLoadMD2"
...
EndRem
Function bbAnimateMD2(md2,mode=0,speed#=1.0,first_frame=1,last_frame=0,transition#=0)="bbAnimateMD2"
...
EndRem
Function bbMD2AnimTime(md2)="bbMD2AnimTime"
...
EndRem
Function bbMD2AnimLength(md2)="bbMD2AnimLength"
...
EndRem
Function bbMD2Animating(md2)="bbMD2Animating"
...
EndRem
Function bbLoadBSP(file$z,gamma_adjust#=0,parent=0)="bbLoadBSP"
...
EndRem
Function bbBSPAmbientLight(bsp,red#,green#,blue#)="bbBSPAmbientLight"
...
EndRem
Function bbBSPLighting(bsp,use_lightmaps)="bbBSPLighting"
...
EndRem
Function bbCreateListener(parent,rolloff_factor#=1.0,doppler_scale#=1.0,distance_scale#=1.0)="bbCreateListener"
...
EndRem
Function bbEmitSound(sound,entity)="bbEmitSound"
